...
public class Client implements Serializable {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)  //cad code généré automatiquement
	@Column (name="CODE_CLI") //cette annotation n'est pas obligatoire (on peut l'éliminer comme pour les autres attributs et utiliser le nom de l'attribut comme non du colonne )
